...
* `didcomm/v2+cbor`: The encryption envelope, signing mechanism, plaintext conventions, and routing algorithms embodied in this spec, but encoded in the optional CBOR format as a replacent for JSON.
